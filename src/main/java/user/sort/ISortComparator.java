 ...
 * in Review that will be used when sorting. Holds three methods, compareToHelpful,
...
public interface ISortComparator {
    ...
    /** Compares the object to another object by helpfulness.
    ...
    /** Compares the object to another object by highest rating.
     * @param otherReview a second Review to compare to.
     * @return either 0, -1 or 1 corresponding to the order of the compared objects.
     */
    int compareToHighestRating(Review otherReview);

    /** Compares the object to another object by recency.
     * @param otherReview a second Review to compare to.
     * @return either 0, -1 or 1 corresponding to the order of the compared objects.
     */
